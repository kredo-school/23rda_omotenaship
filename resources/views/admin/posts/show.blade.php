...
<div class="container">         
    <div class="row justify-content-center mt-5">
      {{-- image --}}
        <div class="col-7">
            <img src="{{ asset('images/14.png')}}" class="posts-show-image w-100" alt="post image">
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-7">
            <div class="d-flex align-items-center mb-2">
                <i class="fa-solid fa-circle-user text-secondary icon-sm me-2"></i>
                <a href="#" class="text-decoration-none text-dark">Mary Watson</a>
                <p class="show-date m-0 ms-3 ">2024-06-10</p>
            </div>
                <p>beautiful place</p>
        </div>
    </div>

            ...
            <div class="col-lg-6 mx-auto p-0 d-flex justify-content-center align-items-center" style="background-image: url('{{ asset('/storage/logos/red5.jpg') }}'); background-size: cover; background-position: center; height: 100vh;">
                <div class="text-center text-danger w-100" style="max-width: 500px;">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="mt-4">
                        ...
                        <!-- Comfirm password -->
                        <div class="row mb-3">
                            <label for="comfirmpassword" class="col-md-3 col-form-label text-black">{{ __('Comfirm Password') }}</label>
                            <div class="col-md-6">
                                <input id="comfirmpassword" type="text" class="form-control bg-transparent"name="comfirmpassword" value="{{ old('comfirmpassword') }}" required autocomplete="comfirmpassword" autofocus>
                            <!-- ↑のclassに@error('password') is-invalid @enderror -->

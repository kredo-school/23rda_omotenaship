{{-- Delete Acount --}}
<div class="modal fade" id="deleteAccountModal" aria-labelledby="delete-account-modal">
    <div class="modal-dialog modal-sm">
        <div class="modal-content ">
            ...
            <div class="modal-footer account-boder d-flex justify-content-center">
                <button type="button" class="btn border cancel-account-border" data-bs-dismiss="modal">Cancel</button>

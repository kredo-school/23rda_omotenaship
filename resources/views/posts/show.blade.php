            ...
            <div class="row justify-content-center">
                <div class="col-7">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat repudiandae animi ad sunt, odit
                        molestias
                        laudantium quisquam, natus quibusdam, suscipit ab aperiam. Deleniti voluptas voluptatibus quidem
                        aspernatur
                        nobis ex praesentium atque cumque, nesciunt eius, illo eveniet? Quibusdam alias delectus
                        reprehenderit
                        numquam, necessitatibus reiciendis impedit magnam deserunt dolorum maxime, similique Lorem, ipsum
                        dolor
                        sit
                        amet consectetur adipisicing elit. Nulla autem laudantium ad similique illo praesentium alias ipsa
                        animi
                        asperiores quisquam. Amet quisquam fugit in architecto quam deleniti consequuntur aspernatur
                        corporis
                        aliquam qui voluptate impedit perferendis tenetur corrupti pariatur dicta temporibus doloribus nemo,
                        doloremque esse minima at consectetur. Nulla, asperiores eos.</p>
                </div>
            </div>
            {{-- post comment --}}
            <div class="row justify-content-center">
